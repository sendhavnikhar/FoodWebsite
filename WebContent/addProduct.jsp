...
<body style="background-color: #FFFFFF;">
  ...
  box-shadow: 10px 10px 15px rgba(1,1,0,0.05)">
				<div style="font-weight:italic-bold;" class="text-center">
					<h2 style="color: green;">Add Food Dish</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="last_name">Food Name</label> <input type="text"
							placeholder="Enter Product Name" name="name" class="form-control"
							id="last_name" required>
					<br>
					
					<label for="producttype">Food Type</label> <select name="type"
							id="producttype" class="form-control" required>
							<option value="gujrati">GUJRATI</option>
							<option value="rajashthani">RAJASHTHANI</option>
							<option value="punjabi">PUNJABI</option>
							<option value="southindian">SOUTHINDIAN</option>
							<option value="chiniies">CHINIIES</option>
