				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="mobile"
								<%="mobile".equalsIgnoreCase(ptype) ? "selected" : ""%>>GUJRATI</option>
							<option value="tv"
								<%="tv".equalsIgnoreCase(ptype) ? "selected" : ""%>>RAJASHTHANI</option>
							<option value="camera"
								<%="camera".equalsIgnoreCase(ptype) ? "selected" : ""%>>PUNJABI</option>
							<option value="laptop"
								<%="laptop".equalsIgnoreCase(ptype) ? "selected" : ""%>>SOUTHINDIAN</option>
							<option value="tablet"
								<%="tablet".equalsIgnoreCase(ptype) ? "selected" : ""%>>CHINIIES</option>
							<option value="speaker"
								<%="speaker".equalsIgnoreCase(ptype) ? "selected" : ""%>>FAST FOOD</option>
							<option value="other"
