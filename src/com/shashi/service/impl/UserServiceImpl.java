...
public class UserServiceImpl implements UserService {
	...
	@Override
	public String registerUser(String userName,String emailId,String password , String Cpassword) {

		UserBean user = new UserBean(userName, emailId,  password ,Cpassword);
